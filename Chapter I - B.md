...
3. Place `binkw32.dll` and `cstrike` folder into your installed CS1.6 folder. **Metadrawer package will replace `plugins.lst` with its own file if you place then entire `cstrike` folder, unless you want to do it manually.
